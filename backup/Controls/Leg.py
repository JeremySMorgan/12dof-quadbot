...
class Leg(object):
	...
	def legExtend(self, body_delta, middle_delta, leg_delta,middle_raise, velocity, time_delay):

		middle_starting_val = self.middle.value

		self.middle.moveOffSetInT(middle_raise,velocity);
		time.sleep(time_delay)
		...
		self.middle.moveTo( middle_starting_val + middle_delta) 
